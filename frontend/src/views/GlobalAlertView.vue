...
/* ========== 顶栏 ========== */
.bs-head { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:12px; position:relative; z-index:5; flex-shrink:0; }
...
/* 机组选择 */
.bs-unit-bar { display:flex; gap:10px; margin-bottom:12px; position:relative; z-index:5; flex-shrink:0; }
...
/* ================================================================
   ...
   ================================================================ */
.mon-layout { display:flex; flex-direction:column; gap:12px; position:relative; z-index:5; flex:1; min-height:0; overflow:hidden; }
.mon-top-row { flex-shrink:0; }
.matrix-screen { flex:1; min-height:0; }
...
/* ========== 智能分析面板 ========== */
.ana-layout { display:flex; flex-direction:column; gap:12px; position:relative; z-index:5; flex:1; min-height:0; overflow-y:auto; }
