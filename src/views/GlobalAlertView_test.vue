...
<style scoped>
/* ========== 全局 ========== */
.bs { min-height: 100vh; padding: 12px 16px; background: linear-gradient(180deg, #020409 0%, #050810 50%, #03060c 100%); position: relative; overflow-x: hidden; }
...
/* 面板切换按钮 */
.panel-switch { display: flex; gap: 2px; background: rgba(7,11,21,0.42); border: 0.5px solid rgba(59,130,246,0.2); border-radius: 8px; padding: 3px; }
...
/* ========== 机组选择条 ========== */
.bs-unit-bar { display: flex; align-items: center; gap: 8px; margin-bottom: 14px; padding: 8px 14px; background: rgba(7,11,21,0.35); border: 0.5px solid rgba(59,130,246,0.15); border-radius: 10px; position: relative; z-index: 2; backdrop-filter: blur(8px); }
.bs-ub-lbl { font-size: 16px; color: #f59e0b; }
.bs-ub-card { display: flex; align-items: center; gap: 8px; padding: 6px 14px; border-radius: 6px; cursor: pointer; transition: all 0.2s; border: 0.5px solid transparent; background: rgba(7,11,21,0.28); }
...
.kpi-item { display: flex; align-items: center; gap: 10px; padding: 12px 14px; background: rgba(7,11,21,0.35); border: 0.5px solid rgba(59,130,246,0.12); border-radius: 10px; backdrop-filter: blur(8px); transition: all 0.25s; }
...
/* ========== 蜂窝矩阵区域 ========== */
.matrix-zone { position: relative; z-index: 2; margin-bottom: 14px; background: rgba(7,11,21,0.245); border: 0.5px solid rgba(59,130,246,0.15); border-radius: 12px; padding: 16px 20px 20px; backdrop-filter: blur(8px); }
...
.hc-cell.empty { background: rgba(15,20,29,0.21); cursor: default; }
...
.tz-card { background: rgba(7,11,21,0.315); border: 0.5px solid rgba(59,130,246,0.12); border-radius: 10px; padding: 12px 16px; backdrop-filter: blur(8px); }
...
.pa-card { background: rgba(7,11,21,0.315); border: 0.5px solid rgba(59,130,246,0.12); border-radius: 10px; padding: 14px; backdrop-filter: blur(8px); }
